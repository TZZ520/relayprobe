...
本文记录 relayprobe 设计阶段参考过的公开 GitHub 项目。完整致谢见 [docs/credits.md](credits.md)。列出这些项目不是暗示它们有恶意，而是因为它们公开展示了真实世界里中转、网关、路由、切换器和安全代理可能具备的能力。
...
- [@QuantumNous/new-api](https://github.com/QuantumNous/new-api) / [@Calcium-Ion/new-api](https://github.com/Calcium-Ion/new-api)
  - 中文生态常见 API 管理与分发系统。
  - 公开代码中可见 model mapping、parameter override、header override、system prompt override、cache/usage accounting 等能力。
...
- [@musistudio/claude-code-router](https://github.com/musistudio/claude-code-router)
  - Claude Code 路由项目。relayprobe 的本地配置检测路径参考了这类 Claude Code router 风格设置。
- [@farion1231/cc-switch](https://github.com/farion1231/cc-switch)
  - 面向 Claude Code、Codex、OpenCode、OpenClaw、Gemini CLI 等工具的跨平台助手/切换器。
- [@huangdijia/ccswitch](https://github.com/huangdijia/ccswitch)
  - 用于管理和切换 Claude Code API 配置的命令行 profile 工具。
